<template>
  <img class="accessoriesTop" :src="accessoriesTopImg" alt=""/>
...
<script setup>
import accessoriesTopImg from "@/assets/accessoriesTopImg.png";
...
const filteredProductList = computed(() => {
  return productList.value.filter(product => product.categoryId === 4);
});
